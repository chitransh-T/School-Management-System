  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="p-6 max-w-4xl mx-auto my-12">
        <h1 className="text-2xl font-semibold mb-8 text-center text-gray-900">Update Attendance</h1>
        ...
        <div className="mb-8">
          <div className="flex gap-4 justify-between mb-8">
            ...
            />
            <select
              className="flex-1 p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-400"
            >
