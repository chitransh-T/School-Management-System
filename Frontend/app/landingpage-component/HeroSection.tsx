...
export default function HeroSection() {
  ...
  return (
    <section
      ref={heroRef}
      className="relative w-full pt-32 pb-20 lg:pt-40 lg:pb-28 transition-all duration-700 ease-in-out animate-fade-in parallax-bg parallax-mouse bg-blue-50 min-h-[400px]"
    >
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center min-h-[300px]">
          <div className="lg:pr-16 max-w-2xl transition-transform duration-700 ease-in-out hover:scale-105 overflow-hidden">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-800 leading-tight mb-6 transition-colors duration-500 font-sans tracking-tight [-webkit-font-smoothing:antialiased] [-moz-osx-font-smoothing:grayscale] break-words">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed mb-8 transition-opacity duration-700 opacity-90 font-sans tracking-normal [-webkit-font-smoothing:antialiased] [-moz-osx-font-smoothing:grayscale] line-clamp-3 break-words">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
              <button
                ...
                className="px-6 py-2 text-lg font-semibold bg-gradient-to-r from-blue-600 to-sky-600 text-white rounded-lg hover:from-blue-700 hover:to-sky-700 transition-all duration-300 shadow-md hover:shadow-xl transform hover:-translate-y-1 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-blue-200 font-sans"
              >
                Get Started
              </button>
              <button
                onClick={navigateToAboutUs}
                className="px-6 py-2 text-lg font-semibold bg-white text-blue-600 rounded-lg border-2 border-blue-600 hover:bg-blue-50 transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-blue-200 font-sans"
              >
                Learn More
              </button>
            </div>
