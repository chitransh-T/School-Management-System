...
//               toggleSidebar();
//               toggleSidebar1();
//               setIsStudentOpen(false); // Close student subfield when toggling
//               setIsTeacherOpen(false);
//               setIsAttendanceOpen(false); // Close attendance subfield when toggling
//               }} 
...
//            <li className="mb-4">
//               <button 
//                 onClick={() => setIsTeacherOpen(!setIsTeacherOpen)}
//                 className={`w-full hover:text-gray-600 flex items-center justify-between ${isStudentRoute ? 'text-blue-600 font-medium' : ''}`}
//               >
//                 <div className="flex items-center">
//                   <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
...
//                         <div className={`p-2 hover:bg-gray-200 rounded-md ${pathname === '/studentattendance/markattendance' ? 'bg-gray-200' : ''}`}>
//                           <Link href="/studentattendance/markattendance" className="hover:text-gray-600 flex items-center w-full">
//                             <span className="text-sm"> - Mark Teacher Attendance</span>
//                           </Link>
//                         </div>
//                       </li>
//                       <li>
//                         <div className={`p-2 hover:bg-gray-200 rounded-md ${pathname === '/studentattendance/attendancereport ' ? 'bg-gray-200' : ''}`}>
//                           <Link href="/studentattendance/attendancereport" className="hover:text-gray-600 flex items-center w-full">
//                             <span className="text-sm"> - Teacher Attendance Reports</span>
//                           </Link>
//                         </div>
//                       </li>
...
// function setIsTeacherOpen(arg0: boolean) {
            ...
            <li className="mb-4">
              ...
              {isStudentOpen && (
                <ul className="ml-6 mt-2 space-y-2">
                  ...
                  <li>
                    <div className={`p-2 hover:bg-gray-200 rounded-md ${pathname === '/transfercertificate' ? 'bg-gray-200' : ''}`}>
                      <Link href="/transfercertificate" className="hover:text-gray-600 flex items-center w-full">
                        <span className="text-sm">Transfer Certificate</span>
                      </Link>
                    </div>
                ...
                <ul className="ml-6 mt-2 space-y-2">
                  <li>
                    <div className={`p-2 hover:bg-gray-200 rounded-md ${pathname === '/addteacher' ? 'bg-gray-200' : ''}`}>
                      <Link href="/addTeacher" className="hover:text-gray-600 flex items-center w-full">
                        <span className="text-sm">Add New Teacher</span>
                      </Link>
                    </div>
                  </li>
                  <li>
                    <div className={`p-2 hover:bg-gray-200 rounded-md ${pathname === '/TeacherDetails' ? 'bg-gray-200' : ''}`}>
                      <Link href="/TeacherDetails" className="hover:text-gray-600 flex items-center w-full">
                        <span className="text-sm">View Teacher Details</span>
                      </Link>
                    </div>
                  </li>
                  <li>
                    ...
                    <ul className="ml-4 mt-2 space-y-2">
                      <li>
                        <div className={`p-2 hover:bg-gray-200 rounded-md ${pathname === '/teacherabsent/markattendance' ? 'bg-gray-200' : ''}`}>
                          <Link href="/teacherabsent/markattendance" className="hover:text-gray-600 flex items-center w-full">
                            <span className="text-sm"> - Mark Teacher Attendance</span>
                          </Link>
                        </div>
                      </li>
                      <li>
                        <div className={`p-2 hover:bg-gray-200 rounded-md ${pathname === '/teacherabsent/attendancereport' ? 'bg-gray-200' : ''}`}>
                          <Link href="/teacherabsent/attendancereport" className="hover:text-gray-600 flex items-center w-full">
                            <span className="text-sm"> - Teacher Attendance Reports</span>
                          </Link>
                        </div>
                      </li>
